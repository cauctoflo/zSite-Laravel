...
<html lang="en">
   ...
   <body class="bg-gray-900">
      ...
      {{-- <div class="flex w-screen flex-col shadow-sm rounded-xl bg-gray-700 hover:bg-gray-700 hover:opacity-90 cursor-pointer transition duration-300 ease-in-out">
      
      </div> --}}
      <div id="container" class="bg-custom-color mt-16 p-4 mx-auto w-screen max-w-[85rem] overflow-hidden   rounded-lg">
      ...
      <div id="container3" class="bg-custom-color mt-16 p-4 mx-auto w-screen max-w-[85rem] overflow-hidden   rounded-lg">
      ...
      </div><div id="container2" class="bg-custom-color mt-16 p-4 mx-auto w-screen max-w-[85rem] overflow-hidden   rounded-lg">
