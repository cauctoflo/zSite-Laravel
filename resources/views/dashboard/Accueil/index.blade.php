                  ...
                  <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-2 ">
                     ...
                     <div class=" mr-4 bg-gray-800 hover:bg-gray-700 group cursor-pointer p-6 max-h-[256px] overflow-hidden rounded-lg bg-dark-800  grid grid-cols-1 gap-2 transition-all duration-200 hover:shadow-lg">
                        <div class="flex items-center justify-between">
                           <img width="48" class="text-white" height="64" src="https://img.icons8.com/wired/64/CF823B/module.png" alt="module"/>
                           <div class="w-32 h-12 font-bold  text-sm text-center justify-center rounded-full " style="color: rgba(255, 195, 79, 1) !important; background-color: rgba(255, 196, 79, 0.349) !important;">
                              <span class=" flex items-center justify-center h-full">
                                 <svg class="w-8 h-8 mr-2"  xmlns="http://www.w3.org/2000/svg" id="emoji" viewBox="0 0 72 72" version="1.1">
                                    <g id="color">
                        ...
                        <div>
                           <p class="text-white font-semibold text-base">Arrivées &amp; Départs</p>
                           <p class="text-sm text-dark-300 mt-2">Envoyez automatiquement des messages et attribuez des rôles à vos nouveaux membres et envoyez un message lorsqu'un membre quitte...</p>
                        </div>
                        <div class="pointer-events-none">
                           <button style="background-color: rgba(255, 196, 79, 0.349); color: rgba(255, 195, 79, 1) !important;" class=" text-lg text-bold relative flex overflow-hidden shrink-0 rounded-lg transition-all duration-200 items-center  gap-1.5 bg-brand-default  undefined  px-4 py-2" ">
                              ...
                              <div class="flex grow justify-center max-w-full"><span class="transition-all duration-200 whitespace-nowrap text-ellipsis overflow-hidden block w-full shrink-0 text-center">Active</span></div>
                           </button>
                        </div>
                     </div>
                     
                     <div class="mr-4 bg-gray-800 hover:bg-gray-700 group cursor-pointer p-6 max-h-[256px] overflow-hidden rounded-lg bg-dark-800  grid grid-cols-1 gap-3 transition-all duration-200 hover:shadow-lg">
                        <div class="flex items-center justify-between">
                           <img width="48" class="text-white" height="64" src="https://img.icons8.com/wired/64/CF823B/module.png" alt="module"/>
                           <div class="w-32 h-12 font-bold  text-sm text-center justify-center rounded-full " style="color: rgba(255, 195, 79, 1) !important; background-color: rgba(255, 196, 79, 0.349) !important;">
                              <span class=" flex items-center justify-center h-full">
                     ...
                     <div class="bg-gray-800 hover:bg-gray-700 mr-4 group cursor-pointer p-6 max-h-[256px] overflow-hidden rounded-lg bg-dark-800  grid grid-cols-1 gap-3 transition-all duration-200 hover:shadow-lg">
                        <div class="flex items-center justify-between">
                           <img width="48" class="text-white" height="64" src="https://img.icons8.com/wired/64/CF823B/module.png" alt="module"/>
                           <div class="w-32 h-12 font-bold  text-sm text-center justify-center rounded-full " style="color: rgba(255, 195, 79, 1) !important; background-color: rgba(255, 196, 79, 0.349) !important;">
                              <span class=" flex items-center justify-center h-full">
                     ...
                     <div class="bg-gray-800 hover:bg-gray-700 group cursor-pointer p-6 max-h-[256px] overflow-hidden rounded-lg bg-dark-800  grid grid-cols-1 gap-3 transition-all duration-200 hover:shadow-lg">
                        <div class="flex items-center justify-between">
                           <img width="48" class="text-white" height="64" src="https://img.icons8.com/wired/64/CF823B/module.png" alt="module"/>
                           <div class="w-32 h-12 font-bold  text-sm text-center justify-center rounded-full " style="color: rgba(255, 195, 79, 1) !important; background-color: rgba(255, 196, 79, 0.349) !important;">
                              <span class=" flex items-center justify-center h-full">
