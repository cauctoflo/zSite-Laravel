...
<html lang="en">
   ...
   <body class="bg-gray-900">
    ...
    <div class="">
        ...
        <div class="min-w-[300px] scroll-m-1 bg-gray-900 text-white transform -translate-x-full absolute lg:!translate-x-0 left-0 top-0 lg:relative transition-all duration-200 z-[50] h-screen -translate-x-full md:-translate-x-[full]" style="padding-left: 10.5px; width: 350.5px;">
            ...
            <div class="p-5">
               ...
               <div class="mt-5">
                  <div class="relative ">
                     ...
                     <div class="top-[50px] absolute absolute left-0 z-10 w-full rounded-lg bg-gray-700 max-h-[320px] overflow-auto transition-all duration-200 shadow-sm p-2 transform
